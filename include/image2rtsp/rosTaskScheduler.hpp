#ifndef IMAGE2RTSP_ROS_TASKSCHEDULER
#define IMAGE2RTSP_ROS_TASKSCHEDULER

#include <cstdio>

#include "ros/ros.h"

#include <live555/BasicUsageEnvironment0.hh>
#include <live555/BasicUsageEnvironment.hh>
#include <live555/HandlerSet.hh>
...
class RosTaskScheduler : public BasicTaskScheduler0{
  public:
    static RosTaskScheduler *createNew(unsigned maxSchedulerGranularity = 10000 /*microseconds*/){
        	return new RosTaskScheduler(maxSchedulerGranularity);
    }

    virtual ~RosTaskScheduler(){
  ...
  protected:
    RosTaskScheduler(unsigned maxSchedulerGranularity) : fMaxSchedulerGranularity(maxSchedulerGranularity), fMaxNumSockets(0){
        FD_ZERO(&fReadSet);
        FD_ZERO(&fWriteSet);
    ...
    static void schedulerTickTask(void *clientData){
          ((RosTaskScheduler*)clientData)->schedulerTickTask();
    }
